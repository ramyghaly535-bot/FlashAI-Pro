...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'device.brand': 'Brand',
    'device.model': 'Model',
    'device.model_code': 'Board Config',
  ...
  ar: {
    ...
    'device.chipset': 'المعالج',
    'device.baseband': 'الراديو',
    'device.display': 'الشاشة',
    'device.security_patch': 'تحديث الأمان',
    'device.region': 'المنطقة',
